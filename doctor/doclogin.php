...
$sql="SELECT name, password, designation FROM user WHERE name = '$name'";
...
<body>
    ...
    <img src="../images/docavatar.jpg" alt="DoctorAvatar" class="avatar" align="right">
    <p style="color: aqua; text-align: center;position: relative;  "><font size="4"><strong>Doctor</strong> Login</font></p>
	</div>
