...
<body>
  ...
  <script>openNav();</script>
	...
	<div id="selection" class="options">
		<a id="box1" href="blog1.php" target="_blank" class="box" >Today's log</a>
		<br>
		<a id="box2" href="#" class="box" onclick="show2()">Daywise log</a>
		<br>
		<a id="box3" href="#" class="box" onclick="show3()">Patient bill log</a>
	</div>
		<form id="datelist" name="datelist" action="blog2.php" target="_blank" method="post">
		...
		<button type="submit" style="background-color: limegreen;">Get list</button>
			...
			<form id="personlist" name="personlist" action="blog3.php" target="_blank" method="post">



		<label for="idid">Patient ID</label><br>
		<input type="number" name="idid" placeholder="Enter ID" required>
		<br>
...
<script>
	...
	document.getElementById('back').style.display='inline-block';
	document.getElementById( 'personlist' ).style.display = 'inline-block';
