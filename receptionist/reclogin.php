...
if($row["designation"] == $designation){
	...
	header("location: rechome.php");
		...
		echo "<script>
					alert('You need to be a receptionist!');
...
<body>
    ...
    <img src="../images/recavatar.jpg" alt="ReceptionistAvatar" class="avatar" align="right">
    <p style="color: aqua; text-align: center;position: relative;  "><font size="4"><strong>Receptionist</strong> Login</font></p>
	</div>
