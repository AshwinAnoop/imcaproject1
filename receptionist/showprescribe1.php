...
$pdf->AddPage();
$preid = $_POST['preno'];
$result = mysqli_query($conn, "SELECT dosage.medqty, dosage.intake, medicine.med FROM dosage,medicine WHERE pre_id='$preid' AND dosage.med_id=medicine.med_id") or die("database error:". mysqli_error($conn));
