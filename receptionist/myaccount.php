...
<body>
	...
	<div id="selection" class="options">
		...
		<form id="pswchange" name="pswchange" action="recpswchange.php" onSubmit="return checkpsw()" method="post">
		...
		<form id="phnochange" name="phnochange" action="recphnchange.php" onSubmit="return checkphno()" method="post">
		...
		<form id="mailchange" name="mailchange" action="recmailchg.php" onSubmit="return checkmail()" method="post">
